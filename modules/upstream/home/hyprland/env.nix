  ...
  wayland.windowManager.hyprland = {
    settings = {
      env = [
        ...
        "GDK_SCALE,1"
        "QT_SCALE_FACTOR,1"
        # MODIFIED: hx -> nvim. Hyprland env= ueberschreibt
        # home.sessionVariables komplett, daher muss EDITOR hier
        # gesetzt werden, sonst erben alle Hyprland-Children (kitty,
        # yazi via Super+Y, rofi, ...) noch das alte EDITOR=hx.
        "EDITOR,nvim"
